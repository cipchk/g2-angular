  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item"><a class="nav-link" [routerLink]="['/k-chart']">K Chart</a>
        ...
        <li class="nav-item"><a class="nav-link" [routerLink]="['/map']">ChinaMap</a>
        <li class="nav-item"><a class="nav-link" [routerLink]="['/treemap']">TreeMap</a>
        <li class="nav-item"><a class="nav-link" [routerLink]="['/dashboard']">Dashboard</a>
        <li class="nav-item"><a class="nav-link" [routerLink]="['/diagram']">Diagram</a>
        <li class="nav-item"><a class="nav-link" [routerLink]="['/boxplot']">BoxPlot</a>
        <li class="nav-item"><a class="nav-link" [routerLink]="['/aster']">Aster</a>
        <li class="nav-item"><a class="nav-link" [routerLink]="['/tree-m']">tree-m</a>
        <li class="nav-item"><a class="nav-link" [routerLink]="['/contour']">Contour</a>
      </ul>
    </div>
  </nav>
